...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        let block = chain.mineBlock([
            Tx.contractCall('blockchain-anonymity-service', 'initialize', [], deployer.address)
        ]);
        ...
        block = chain.mineBlock([
            Tx.contractCall('blockchain-anonymity-service', 'initialize', [], user1.address)
        ]);
...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        // Pause the service
        let block = chain.mineBlock([
            Tx.contractCall('blockchain-anonymity-service', 'pause-service', [], deployer.address)
        ]);
        ...
        // Resume the service
        block = chain.mineBlock([
            Tx.contractCall('blockchain-anonymity-service', 'resume-service', [], deployer.address)
        ]);
        ...
        block = chain.mineBlock([
            Tx.contractCall('blockchain-anonymity-service', 'pause-service', [], user1.address)
        ]);
        ...
        block = chain.mineBlock([
            Tx.contractCall('blockchain-anonymity-service', 'resume-service', [], user1.address)
        ]);
